            ...
            <div className="space-y-8 w-full max-w-md">
               ...
               <div className="mb-8 text-center">
                  <div className="flex flex-col gap-2 items-center group">
                     <div
                        className="flex justify-center items-center rounded-xl transition-colors size-12 bg-primary/10 group-hover:bg-primary/20"
                     >
               ...
               <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="form-control">
                     ...
                     <div className="relative">
                        <div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                           <User className="z-10 text-primary size-5 text-base-content/40" />
                        </div>
                        <input
                           type="text"
                           className={`pl-10 w-full input input-bordered`}
                           placeholder="Khalid Nasser"
                  ...
                  <div className="form-control">
                     ...
                     <div className="relative">
                        <div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                           <Mail className="z-10 size-5 text-primary text-base-content/40" />
                        </div>
                        <input
                           type="email"
                           className={`pl-10 w-full input input-bordered`}
                  ...
                  <div className="form-control">
                     ...
                     <div className="relative">
                        <div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                           <Lock className="z-10 size-5 text-primary text-base-content/40" />
                        </div>
                        <input
